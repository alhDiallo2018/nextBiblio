 ...
 *     description: Permet de récupérer la liste de tous les utilisateurs présents dans la base de données.
 *     responses:
 *       200:
 ...
 *     description: Permet de récupérer un utilisateur spécifique à partir de son identifiant unique.
 *     parameters:
 *       - in: path
 *         name: userId
 *         required: true
